...
# %%
# data = arquivo_lido()
def matriz_descontos_lojas(data, budget):
    ...
    data = pd.merge(data, budget, on="cod_loja", how="left")
    ...
    base_matriz_per_ano = base_matriz_per_ano[["Cod. Loja", "Desc. Loja", r'% Desc. 2025', r'% Budget', r"Δ p.p (25xBudget)", r'% Desc. 2024', r"Δ p.p (25x24)", r'% Desc. 2023', r"Δ p.p (25x23)"]]
